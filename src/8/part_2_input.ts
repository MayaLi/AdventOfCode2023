...
export const PART_2_INSTRUCTIONS =
...
export const PART_2_NETWORK: Network = {
    QRX: ['XNN', 'TCJ'],
    GSM: ['PNH', 'BVG'],
    VDX: ['VSG', 'ZZZ'],
    TGV: ['SHD', 'FVB'],
...
export const PART_2_NETWORK_EXAMPLE: Network = {
    '11A': ['11B', 'XXX'],
    '11B': ['XXX', '11Z'],
    '11Z': ['11B', 'XXX'],
    '22A': ['22B', 'XXX'],
...
export const PART_2_INSTRUCTIONS_EXAMPLE = 'LR'
