...
export const PART_1_INSTRUCTIONS =
...
export const PART_1_NETWORK: Network = {
  QRX: ["XNN", "TCJ"],
  GSM: ["PNH", "BVG"],
  VDX: ["VSG", "ZZZ"],
  TGV: ["SHD", "FVB"],
...
export const PART_1_NETWORK_EXAMPLE: Network = {
  AAA: ["BBB", "CCC"],
  BBB: ["DDD", "EEE"],
  CCC: ["ZZZ", "GGG"],
  DDD: ["DDD", "DDD"],
...
export const PART_1_INSTRUCTIONS_EXAMPLE = "LR";